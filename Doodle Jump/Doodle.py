...
#load images
jumpy_image = pygame.image.load('jump.png')
bg_image = pygame.image.load('bg.png')
platform_image = pygame.image.load('wood.png')
...
while run:
	...
	if game_over == False:
		...
		if fade_counter < SCREEN_WIDTH:
			...
			draw_text('GAME OVER!', font_big, WHITE, 155, 200)
			draw_text('SCORE: ' + str(score), font_big, WHITE, 170, 250)
			draw_text('PRESS SPACE TO PLAY AGAIN', font_big, WHITE, 85, 300)
			#update high score
			if score > high_score:
				high_score = score
